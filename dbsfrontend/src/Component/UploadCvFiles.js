...
class UploadCvFiles extends Component {
  constructor(props) {
    super(props);
  ...
  saveCvFile = (e) => {
    ...
    form_data.append("file", this.state.resumefile, this.state.resumefile.name);
    let url = "http://localhost:8080/dbsoApp/upload-cv/" + this.state.cgGroupId;
    axios
      .put(url, form_data, {
        headers: {
                    ...
                    <form>
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={this.changeCvFileHandler}
                          required
                        />
                      </div>
                      <br></br>
                      <button className="button" onClick={this.saveCvFile}>
                        Save
                      </button>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
